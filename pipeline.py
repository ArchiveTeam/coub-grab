...
LUA_SHA1 = get_hash(os.path.join(CWD, 'coub.lua'))
    ...
    def realize(self, item):
        ...
        for item_name in item['item_name'].split('\0'):
            ...
            if item_type == 'v':
                ...
                wget_args.append('https://coub.com/api/v2/coubs/'+item_value)
            else:
...
project = Project(
    title='Coub',
    project_html='''
        <img class="project-logo" alt="Project logo" src="https://wiki.archiveteam.org/images/3/32/Coub_logo.png" height="50px" title=""/>
        <h2>coub.com <span class="links"><a href="https://coub.com/">Website</a> &middot; <a href="http://tracker.archiveteam.org/coub/">Leaderboard</a></span></h2>
        <p>Archiving everything from Coub.</p>
    '''
)
